...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($resultSql) < 1) {
        // Query the data
        $query = "INSERT INTO insurance (name, ic, email, phone, occupation, age, street1, street2, postcode, state, nomineeName, nomineeIC, nomineeRelationship, hotelList, hotelStay, hotelDate, createdAt, total, balance) 
        VALUES
        ('$name', '$ic', '$email', '$phone', '$occupation', '$age', '$street1','$street2', '$postcode', '$state', '$nomineeName', '$nomineeIC', '$nomineeRelationship', '$hotelList','$hotelStay','$hotelDate', '$dateTime', 497, 497)";
