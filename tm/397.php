...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($resultSql) < 1) {
        ...
        VALUES
        ('$name', '$ic', '$email', '$phone', '$occupation', '$age', '$street1','$street2', '$postcode', '$state', '$nomineeName', '$nomineeIC', '$nomineeRelationship', '$dateTime', 397, 397)";
        ...
        if ($result = mysqli_query($conn, $query)) {
            ...
            $to = $email;
            $subject = "Group Personal Accident Special Insurance Plan - " . $name;
            $text =
                "<html>

        <head>
            <title>Group Personal Accident Special Insurance Plan</title>
        </head>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card my-4">
                    <div class="card-header text-center">
                        Group Personal Accident Special Insurance Plan
                    </div>
                    <div class="card-body">
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" class="md-form form-sm " method="POST">
                            ...
                            <div class="col-12">
                                <hr>
                                <p class="text-center"><small>Total is <b>RM397</b></small></p>
                                <hr><br>
                                <div class="row mb-2">
